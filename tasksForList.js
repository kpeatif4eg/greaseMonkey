            ...
            tasks: [
                {
                    ...
                    showBtn: true,
                    sides: [
                        { side: { name: 'Замена масла в двигателе + масл. фильтр', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена масла в АКПП', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена масла в МКПП', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена масла в переднем мосту', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена масла в заднем мосту', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена масла в раздатке', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена масла в ГУР', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена антифриза', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена тормозной жидкости', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Заправка мочевины(AdBlue)', value: '', isChecked: false, cost: '' } },
                    ]
                },
                {
                    title: 'Фильтры',
                    showBtn: true,
                    sides: [
                        { side: { name: 'Замена топливного фильтра', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена воздушного фильтра', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена салонного фильтра', value: '', isChecked: false, cost: '' } },
                    ]
                },
                {
                    title: 'Тормоза',
                    showBtn: true,
                    sides: [
                        { side: { name: 'Замена передних колодок', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена задних колодок', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена передних дисков', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена задних дисков', value: '', isChecked: false, cost: '' } },
                    ]
                },
                {
                    title: 'Кондиционер',
                    showBtn: true,
                    sides: [
                        { side: { name: 'Заправка кондиционера', value: '', isChecked: false, cost: '' } },
                    ]
                },
            ]
        }
    },
    attachmentsEquipmentGlobal:{
        attachment:{
            area:'Навесное оборудование двигателя',
            tasks:[
                {
                    title:'Генератор',
                    showBtn:true,
                    sides:[
                        { side: { name: 'Снятие-установка генератора', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Ремонт генератора', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена обгонной муфты', value: '', isChecked: false, cost: '' } },
                    ]
                },
                {
                    title:'Стартер',
                    showBtn:true,
                    sides:[
                        { side: { name: 'Снятие-установка стартера', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Ремонт стартера', value: '', isChecked: false, cost: '' } },
                ...
                },
                {
                    ...
                    showBtn:true,
                    sides:[
                        { side: { name: 'Снятие-установка компрессора кондиционера', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Ремонт компрессора кондиционера', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена подшипника эл. муфты компрессора кондиционера', value: '', isChecked: false, cost: '' } },
                    ]
                },
                {
                    title:'Насос ГУР',
                    showBtn:true,
                    sides:[
                        { side: { name: 'Снятие-установка насоса ГУР', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Ремонт насоса ГУР', value: '', isChecked: false, cost: '' } },
                    ]
                },
                {
                    title:'Натяжитель приводного ремня / ролики',
                    showBtn:true,
                    sides:[
                        { side: { name: 'Замена натяжителя ремня с роликом', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена ролика натяжителя ремня', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Замена роликов >=2', value: '', isChecked: false, cost: '' } },
                    ]
                },
                {
                    ...
                    showBtn:true,
                    sides:[
                        { side: { name: 'Замена приводного ремня', value: '', isChecked: false, cost: '' } },
                        { side: { name: 'Ручная натяжка приводного ремня', value: '', isChecked: false, cost: '' } },
                    ]
                },
            ]
        }

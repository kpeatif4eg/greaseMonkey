...
export const ADD_CUSTOM_WORK_TASKITEM = 'ADD_CUSTOM_WORK_TASKITEM';
export const ADD_CUSTOM_WORK_TASK = 'ADD_CUSTOM_WORK_TASK';
export const REMOVE_CUSTOM_WORK_TASKITEM = 'REMOVE_CUSTOM_WORK_TASKITEM';
export const REMOVE_CUSTOM_WORK_TASK = 'REMOVE_CUSTOM_WORK_TASK';

export const SET_CUSTOM_WORK_TITLE = 'SET_CUSTOM_WORK_TITLE';
export const SET_CUSTOM_WORK_TASKITEM = 'SET_CUSTOM_WORK_TASKITEM';
export const SET_CUSTOM_WORK_COST = 'SET_CUSTOM_WORK_COST';
